...
class scoreController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $scores = $em->getRepository('KikiceBundle:score')->findAll();
    ...
    {
        $score = new Score();
        $form = $this->createForm('KikiceBundle\Form\scoreType', $score);
    ...
    {
        $deleteForm = $this->createDeleteForm($score);
        $editForm = $this->createForm('KikiceBundle\Form\scoreType', $score);
